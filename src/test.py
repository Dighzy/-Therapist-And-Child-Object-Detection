...
if __name__ == '__main__':
    ...
    # Path to yout test video
    path = '../videos/originals/Matching.mp4'

    model_pipeline(path, yolo_model, tracker, face_detection, emotion_classifier, emotions, detection_threshold)